...
@Composable
fun OptiTripResultView(result: OptiTripResult) {
    Column(){
        Text(text = stringResource(R.string.result_best_speed, result.speed))
        Text(text = stringResource(R.string.result_final_speed_equiv, result.speedEquiv))
        ...
        Text(text = stringResource(R.string.result_charge_equiv_speed, 100))
        ...
        Text(text = stringResource(R.string.result_distance_charge_1, 100))
        Text(text = stringResource(R.string.result_distance_charge_2, 100))
        Text(text = stringResource(R.string.result_distance_charge_3, 100))
